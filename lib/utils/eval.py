...
sys.path.insert(0, osp.dirname(osp.abspath(osp.dirname(__file__))))
...
def search_object(
    ...
    elif data_config.name == "hot3d":
        obj_names = hot3d_obj_name
...
def get_obj_file(obj_root, object_name, data_config):
    if data_config.name == "h2o":
        ...
        obj_file = "data/hot3d/pre-process/223371871635142.ply"
